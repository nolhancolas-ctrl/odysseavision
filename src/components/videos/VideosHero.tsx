        ...
        <div className="pointer-events-none relative hidden h-[520px] lg:block">
          {heroTurtle ? (
            <PhotoFrame
              ...
              className="absolute right-[-66%] top-[70px] z-40 h-[165px] w-[145px] rotate-[-3deg] border-[6px] border-white/85 shadow-2xl xl:h-[195px] xl:w-[170px]"
            />
          ) : null}
          ...
          {heroRoadtrip ? (
            <PhotoFrame
              ...
              className="absolute right-[-22%] top-[10px] z-30 h-[175px] w-[260px] rotate-[4deg] border-[6px] border-white/85 shadow-2xl"
            />
          ) : null}
