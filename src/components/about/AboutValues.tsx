...
const valueIcons = [
  { src: "/images/about/values_icon_01.png", className: "h-24 w-24" },
  { src: "/images/about/values_icon_02.png", className: "h-24 w-24" },
  { src: "/images/about/values_icon_03.png", className: "h-24 w-24" },
  { src: "/images/about/values_icon_04.png", className: "h-24 w-24" },
  { src: "/images/about/values_icon_05.png", className: "h-24 w-24" },
] as const;
  ...
  return (
    <section className="relative overflow-hidden bg-[#10190f] px-6 py-20 text-[#f4efe4] md:px-14 md:py-24">
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(38, 54, 35, 0.78), rgba(41, 50, 39, 0.86)), url(${aboutImages.valuesFond.src})`,
        }}
      />
