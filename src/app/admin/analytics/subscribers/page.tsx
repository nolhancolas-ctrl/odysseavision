  ...
  return (
    <div className="space-y-7">
      ...
      <section className="grid gap-4 md:grid-cols-3">
        <MetricCard label="Total subscribers" value={data.total} detail="All contacts" />
