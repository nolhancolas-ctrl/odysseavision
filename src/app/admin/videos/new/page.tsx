  ...
  return (
    <div className="space-y-8">
      <header className="flex flex-col justify-between gap-5 md:flex-row md:items-end">
        <div>
          ...
          <p className="mt-3 max-w-2xl text-sm leading-7 text-[#242617]/55">
            Upload the film to Vimeo first, then paste the Vimeo URL here. The
            website will use the Vimeo player and your uploaded thumbnail.
          </p>
        </div>
      ...
      <VideoForm
        ...
        action={createVideo}
        submitLabel="Create Vimeo video"
      />
    </div>
  );
}
